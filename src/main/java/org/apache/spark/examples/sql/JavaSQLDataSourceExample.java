...
private static JdbcOptionsInWrite options;
  // $example off:schema_merging$
...
//    runJdbcDatasetExample(spark);
    runBasicDataSourceExampleCSV(spark);
...
//      .format("jdbc")
//      .option("url", "jdbc:postgresql://winterfeldev19ec.cxamoe94yghn.eu-west-1.rds.amazonaws.com:5432/spark")
//      .option("dbtable", "public.user1")
//      .option("user", "winterfel")
//      .option("password", "aeCtmfgdab1b")
//      .option("driver","org.postgresql.Driver")
//      .load();

    Properties connectionProperties = new Properties();
    connectionProperties.put("user", "winterfel");
    connectionProperties.put("password", "aeCtmfgdab1b");
    connectionProperties.put("driver","org.postgresql.Driver");
    Dataset<Row> jdbcDF2 = spark.read()
      .jdbc("jdbc:postgresql://winterfeldev19ec.cxamoe94yghn.eu-west-1.rds.amazonaws.com:5432/spark", "public.user1", connectionProperties);
    jdbcDF2.show();
    System.out.println(jdbcDF2);
...
//    jdbcDF2.write()
//      .jdbc("jdbc:postgresql:winterfeldev19ec.cxamoe94yghn.eu-west-1.rds.amazonaws.com:5432/spark", "public.user2", connectionProperties);
//
...
//      .jdbc("jdbc:postgresql:dbserver", "schema.tablename", connectionProperties);
  ...
  private static void runBasicDataSourceExampleCSV(SparkSession spark) {
	    ...
	    Dataset<Row> peopleDFCsv = spark.read().format("csv")
	      ...
	      .option("inferSchema", "true")
	      .load("src/main/resources/annuaire/convertcsv_0.csv");
	    
	    peopleDFCsv.show();;
	    peopleDFCsv.write()
	      .format("jdbc")
	      .option("url", "jdbc:postgresql://winterfeldev19ec.cxamoe94yghn.eu-west-1.rds.amazonaws.com:5432/spark")
	      .option("dbtable", "public.people01")
	      .option("user", "winterfel")
	      .option("password", "aeCtmfgdab1b")
	      .option("driver","org.postgresql.Driver")
